...
- ✅ **V1.3a/b** Klienta admin: balvas, personāls, jautājumi, teksti, statistika
...
- ✅ **V1.4d-1** QR-loss recovery (/prize lapa + SMS)
- ⏭️ **NĀKAMAIS: V1.5** — krāšņais animētais rats + skaņa + UI polish → tad MVP tests
- ⏸️ **ATLIKTS pēc MVP:** V1.4d-2 (Google reconciliation), V1.4d-3 (Calendar→bookings ingestion)

DB migrācijas pielietas līdz **0010**. Kods uz `master`.
