...
const MODULE_ICON_MAP: [string, ReactElement][] = [
  ['Spin Reward',             <RotateCcw key="spin-reward" size={14} />],
  ['Darbinieku novērtējums',  <Star key="darb-nov" size={14} />],
  ['Staff rating',            <Star key="staff-rating" size={14} />],
  ['Tips',                    <Heart key="tips" size={14} />],
  ['Google atgādinājums',     <Search key="google-atg" size={14} />],
  ['Google reminder',         <Search key="google-reminder" size={14} />],
  ['Spin+Meta',               <Megaphone key="spin-meta" size={14} />],
  ['Lead Capture',            <ClipboardList key="lead-capture" size={14} />],
  ['Leads sildīšana',         <Bell key="leads-sild" size={14} />],
  ['Lead nurturing',          <Bell key="lead-nurturing" size={14} />],
  ['Digital Stamps',          <CreditCard key="digital-stamps" size={14} />],
  ['Maiņu grafiks',           <CalendarDays key="mainu-grafiks" size={14} />],
  ['Shift schedule',          <CalendarDays key="shift-schedule" size={14} />],
  ['Rezervāciju sistēma',     <CalendarDays key="rezervacijas" size={14} />],
  ['Booking system',          <CalendarDays key="booking-system" size={14} />],
  ['AuraTag',                 <Zap key="auratag" size={14} />],
  ['Onboarding',              <GraduationCap key="onboarding" size={14} />],
]
